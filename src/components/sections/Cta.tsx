...
export default function CTA() {
  const stats = [
    ...
    { value: "24/7", label: "Compliance Support", icon: Sparkles }
  ]
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                ...
                scalable open banking solutions. Start your digital transformation today.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Trusted by leading banks, credit unions, and fintech companies
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Test our APIs risk-free with sample data
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Rapid Integration</h3>
              <p className="text-sm text-muted-foreground">
                Go live in weeks with our guided implementation
              </p>
            </div>
          </div>
        </div>
